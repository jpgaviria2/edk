...
Lightning wallets can be grouped in many ways, but for simplicity, we divide them into two types: self-custodial and custodial.
A self-custodial wallet means you control your keys. A custodial wallet means someone else controls them.
